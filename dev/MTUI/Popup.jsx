...
function Popup(setting){
	...
	//加入内部DIV支持多个弹窗
	$("#MTUI_POPUP").addClass(setting.className).append('<div class="MTUI_DIALOGS" id="MTUI_POPUP_'+timestamp+'"></div>');
	...
	render(
		<div id={popupID} className="mt-popup" style={style}>
	         ...
	         <div className="mt-popup-content">{setting.text==""?setting.text:<div className="mt-popup-str">{setting.text}</div>}</div>
	         {
	         	function(){
