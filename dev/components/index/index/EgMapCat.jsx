...
class EgMapCat extends React.Component {
    constructor(props) {
        ...
        this.state = {
            parmData:{
                data:[
                    {"name": "中国电信股份有限公司贵阳分公司","value": "181"},
                    {"name": "中国移动通信集团贵州有限公司贵阳分公司","value": "349"},
                    {"name": "中国联合网络通信有限公司贵阳市分公司","value": "178"},
                    {"name": "贵州省广播电视信息网络股份有限公司贵阳市分公司","value": "118"},
                    {"name": "京东商城","value": "281"},
                    {"name": "家有购物","value": "780"},
    ...
    render(){
        let propsData = {
            ...
            tooltipFormatter:(p)=>{// 默认可不配置，既不会显示
                return `<span style="font-size:12px;">${p.name}：${p.value[2]}(亿元)</span>`;
            },
            visualMap:{// 默认可不配置,即不会显示
                max:833,// 根据实际情况配置
                text:['高','低'],
                textColor:'#3ed',
                color:['#3DD', '#fff'],
